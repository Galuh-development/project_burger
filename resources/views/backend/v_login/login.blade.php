            ...
            <div class="auth-box bg-white "> 
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        ...
                        <span class="db">
                            <img src="{{ asset('images/logo brgr.png') }}" alt="logo atas" style="width: 150px; margin-bottom: 20px;" />
                        </span>
                        ...
                        <div class="row p-b-30"> 
                            <div class="col-12"> 
                                ...
                                <div class="input-group mb-3"> 
                                    ...
                                    @error('password') 
                                    <span class="invalid-feedback alert-danger" role="alert"> 
                                        {{"Isian email harus berupa alamat surel yang valid"}}   </span> 
                                    @enderror 
                                </div> 
                            </div> 
                        </div> 
                        <div class="row "> 
                            <div class="col-12"> 
                                <div class="form-group"> 
                                    <div class="p-t-20"> 
                                        <button class="btn btn bg-dark text-white" id="to-recover" type="button"><i class="fa fa-lock m-r-5"></i> Lost password?</button> 
                                        <button class="btn bg-warning float-right shadow" type="submit">Login</button> 
                                    </div> 
                                </div> 
                            </div> 
                        </div> 
