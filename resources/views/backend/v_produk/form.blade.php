...
<div class="row"> 
    <div class="col-12"> 
        <div class="card"> 
            <form class="form-horizontal" action="{{ route('v1.backend.laporan.produk.cetak') }}" method="post" target="_blank"> 
                @csrf 
                ...
                <div class="card-body"> 
                    ...
                    <br> 
                    <button type="submit" class="btn btn bg-warning">Cetak</button> 
