...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('frontend/tamplate/img/favicons/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('frontend/tamplate/img/favicons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('frontend/tamplate/img/favicons/favicon-16x16.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('frontend/tamplate/img/favicons/favicon.ico') }}">
    <link rel="manifest" href="{{ asset('frontend/tamplate/img/favicons/manifest.json') }}">
    <meta name="msapplication-TileImage" content="{{ asset('frontend/tamplate/img/favicons/mstile-150x150.png')}}">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{asset('frontend/tamplate/css/theme.css')}}" rel="stylesheet" />
...
@yield('content')
  ...
  <div class="container">
    ...
    <a class="navbar-brand d-inline-flex" href="index.html">
      <img class="d-inline-block" src="{{ asset('images/logo brgr.png') }}" alt="logo" height="40" />
      <span class="text-1000 fs-3 fw-bold ms-2 text-gradient">Burger Queen</span>
    </a>
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center">
        <li class="nav-item">
          <a class="nav-link" href="#">
            <i class="fa fa-user-o me-1"></i> Beranda
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#kategori">
            <i class="fa fa-heart-o me-1"></i> Kategori
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="menu">
            <i class="fa fa-exchange me-1"></i> Produk
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">
            <i class="fa fa-check me-1"></i> Account
          </a>
        </li>
      </ul>
...
<section class="py-5 bg-primary min-vh-100 d-flex align-items-center" id="home">
  <div class="container">
    <div class="row justify-content-center align-items-center">
      <div class="col-md-8 text-center">
        <img class="img-fluid w-100" src="{{ asset('images/menu/Burger_Queen.png') }}" alt="hero-header">
      </div>
    </div>
  </div>
</section>
                  ...
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row gx-3 h-100 align-items-center">
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="images/big burger.png" alt="..." />
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="images/kentang.png" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="images/mie goreng.png" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="images/ramen.png" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3 h-100" src="images/katsu spicy.png" alt="..." />
                          <div class="card-body ps-0">
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="frontend/tamplate/vendors/@popperjs/popper.min.js"></script>
    <script src="frontend/tamplate/vendors/bootstrap/bootstrap.min.js"></script>
    <script src="frontend/tamplate/vendors/is/is.min.js"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="frontend/tamplate/vendors/fontawesome/all.min.js"></script>
    <script src="frontend/tamplate/js/theme.js"></script>
