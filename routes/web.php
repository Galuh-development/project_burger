...
Route::prefix('backend')->name('backend.')->group(function() {
    ...
    Route::prefix('laporan/user')->name('laporan.user.')->controller(App\Http\Controllers\backend\UserController::class)->group(function () {
    ...
    Route::prefix('laporan/produk')->name('laporan.produk.')->controller(App\Http\Controllers\backend\ProdukController::class)->group(function () {
